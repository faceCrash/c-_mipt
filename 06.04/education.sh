...
cp libshared.dylib ../../../libraries || cp libshared.so ../../../libraries || true && cd ../../../
...
cp ../../../libraries/libshared.dylib . || cp ../../../libraries/libshared.so . || true

cp ../source/{font.ttf,image.jpg,script.py,source.cpp} . || true
...
g++ -c -std=c++23 -fmodules-ts -Wall -Wextra -Wpedantic -O0 -xc++-system-header print || true

g++ -c -std=c++23 -fmodules-ts -Wall -Wextra -Wpedantic -O0 ../source/06.15.cxx || true

g++ -c -std=c++23 -fmodules-ts -Wall -Wextra -Wpedantic -O0 ../source/06.13.cxx || true

g++ -c -std=c++23 -fmodules-ts -Wall -Wextra -Wpedantic -O0 ../source/06.14.cxx || true

g++    -std=c++23 -fmodules-ts -Wall -Wextra -Wpedantic -O0 $files -o 06.16 || true
