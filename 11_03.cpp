...
int main() {
  std::cout << "--- Task 11.03: Custom Comparators in QuickSort ---" << std::endl;
  ...
  // 1. Passing standard functional object std::less
  ...
  // 2. Passing custom free function
  ...
  // 3. Passing custom lambda function (by absolute value)
